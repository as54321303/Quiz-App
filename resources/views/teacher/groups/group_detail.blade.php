                                    ...
                                    <div class="item-content table-responsive">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#feedback{{$kid->id}}">
                                                            Feedback
                                                           </button> 
                                                    ...
                                                    <td>
                                                        <a href="{{ route('teacher.remove.group.member',$kid->id) }}">
                                                            <button class="btn btn-danger" onclick="alert('Are you sure?')">Remove</button>
                                                         </a>
                                                    </td>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel">Feedback To Student Parent</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('teacher.student.feedback') }}" method="post">
                                          ...
                                          <label for="title">Title</label>
                                            ...
                                            <textarea class="form-control" name="description" id="description" cols="30" rows="8" placeholder="Write about student..." required></textarea>
